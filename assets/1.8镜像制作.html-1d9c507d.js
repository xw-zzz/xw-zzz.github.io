import{_ as e}from"./plugin-vue_export-helper-c27b6911.js";import{o as n,c as s,e as a}from"./app-c7504387.js";const i={},t=a(`<h2 id="arm-jdk1-8镜像制作" tabindex="-1"><a class="header-anchor" href="#arm-jdk1-8镜像制作" aria-hidden="true">#</a> ARM jdk1.8镜像制作</h2><ul><li><p>首先找一个centos7的基础镜像，并肩jdk安装包复制进去。启动</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>docker run -it --name=mycentos centos

...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li></ul><h3 id="vim-纯文本编辑器" tabindex="-1"><a class="header-anchor" href="#vim-纯文本编辑器" aria-hidden="true">#</a> vim（纯文本编辑器）</h3><ul><li><p>作用：vim分为三种模式：普通模式、编辑模式、命令模式</p><ul><li>普通模式：用vim命令打开一个文件，默认的状态就是普通模式。在这个模式中，不能进行编辑输入操作。</li><li>编辑模式：按i进去编辑模式</li><li>命令模式：输入&quot;: / ?&quot;时，光标会自动定位在那一行，可以执行保存、退出、搜索。</li></ul><p><img src="`+s+'" alt="" loading="lazy"></p></li><li><p>参数：</p><p><img src="'+d+'" alt="" loading="lazy"></p><p><img src="'+i+'" alt="" loading="lazy"></p><p><img src="'+l+`" alt="" loading="lazy"></p></li><li><p>示例：</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment">## 将a文件命名为b</span>
<span class="token function">mv</span> a b
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="" tabindex="-1"><a class="header-anchor" href="#" aria-hidden="true">#</a></h3></li></ul>`,35),p=[c];function v(o,u){return a(),t("div",null,p)}const h=n(r,[["render",v],["__file","0.命令大全.html.vue"]]);export{h as default};

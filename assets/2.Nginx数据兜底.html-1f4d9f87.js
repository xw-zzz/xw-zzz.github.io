import{_ as e}from"./plugin-vue_export-helper-c27b6911.js";import{o as i,c as n,e as r}from"./app-c7504387.js";const a={},d=r(`<h1 id="简介" tabindex="-1"><a class="header-anchor" href="#简介" aria-hidden="true">#</a> 简介</h1><p>如果业务没有做好统一的错误管理，直接暴露给用户，会造成体验上的问题，因为需要进行数据兜底。</p><h1 id="使用" tabindex="-1"><a class="header-anchor" href="#使用" aria-hidden="true">#</a> 使用</h1><p>关键配置如下：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>server {
      listen       8000;
       location /test/ {
         proxy_pass http://lbs;
          # 存放用户的真实ip

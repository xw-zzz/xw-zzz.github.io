import{_ as n}from"./plugin-vue_export-helper-c27b6911.js";import{o as s,c as e,e as a}from"./app-c7504387.js";const i={},l=a(`<h2 id="安装" tabindex="-1"><a class="header-anchor" href="#安装" aria-hidden="true">#</a> 安装</h2><p>目前，Ansible可以在安装了Python 2(版本2.7)或Python 3(版本3.5或更高)的任何机器上运行，</p><p>Fedora：</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">sudo</span> dnf <span class="token function">install</span> ansible

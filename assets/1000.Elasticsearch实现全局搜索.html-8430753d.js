import{_ as n}from"./plugin-vue_export-helper-c27b6911.js";import{o as s,c as a,e as t}from"./app-c7504387.js";const p={},o=t(`<h1 id="_1-原理" tabindex="-1"><a class="header-anchor" href="#_1-原理" aria-hidden="true">#</a> 1.原理</h1><ol><li>使用copy_to将需要查询的参数值复制到一个属性中</li><li>使用wildcard关键词进行查询</li></ol><h1 id="_2-实现" tabindex="-1"><a class="header-anchor" href="#_2-实现" aria-hidden="true">#</a> 2.实现</h1><ol><li><p>创建索引，将所有string类型的数据复制到cmp_full_name中</p><div class="language-json line-numbers-mode" data-ext="json"><pre class="language-json"><code>PUT /cmdb/
